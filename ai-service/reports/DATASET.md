...
| _(dùng chung mọi kịch bản)_ | 7            | `data/intents/global.yaml`       |
| _(nhãn từ chối + meta)_     | 2            | `data/intents/out_of_scope.yaml` |
...
bằng 1 trên các nhãn. Không có lớp từ chối, mô hình _buộc phải_ gán mọi câu vào
...
thoại mới **không cần train lại mô hình**. Chỉ khi thêm _ý định mới_ mới phải
train lại.
