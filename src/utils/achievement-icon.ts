...
const ACHIEVEMENT_ICONS: Record<string, AchievementIconStyle> = {
  ...
  STREAK_3: { icon: "flame", color: "#FF9600" },
  STREAK_7: { icon: "flame", color: "#FF9600" },
  STREAK_30: { icon: "flame", color: "#FF9600" },
  STREAK_100: { icon: "flame", color: "#FF4500" },
  STREAK_365: { icon: "flame", color: "#FF4500" },
  ...
  STREAK_FREEZE_USER: { icon: "snow", color: "#38BDF8" },
